...
================================================================================
  ...
  Database:   TEST_DB
  Schema:     TEST_SCHEMA
  Generated:  2026-08-31T01:32:13Z
...
--     4. Table               : TEST_DB.TEST_SCHEMA.T_ORDERS
--     5. Pipe                : TEST_DB.TEST_SCHEMA.PIPE_T_ORDERS
================================================================================
*/
...
CREATE OR REPLACE STORAGE INTEGRATION AZURE_INT_THESIS
    ...
    STORAGE_ALLOWED_LOCATIONS = ('azure://cntthesis.blob.core.windows.net/cntthesis/');
...
CREATE OR REPLACE STAGE TEST_DB.TEST_SCHEMA.EXT_STAGE_THESIS
    URL = 'azure://cntthesis.blob.core.windows.net/cntthesis/'
...
CREATE OR REPLACE TABLE TEST_DB.TEST_SCHEMA.T_ORDERS (
...
-- ============================================================================
-- 6. PIPE: PIPE_T_ORDERS
-- ============================================================================

CREATE OR REPLACE PIPE TEST_DB.TEST_SCHEMA.PIPE_T_ORDERS
    AUTO_INGEST = TRUE
    INTEGRATION = 'NOTIF_INT_THESIS'
AS
COPY INTO TEST_DB.TEST_SCHEMA.T_ORDERS
FROM (
    SELECT
...
================================================================================
  ...
  Azure Blob Storage (azure://cntthesis.blob.core.windows.net/cntthesis/)
      |
...
================================================================================
  ...
  4. Test each pipe:
       ALTER PIPE TEST_DB.TEST_SCHEMA.PIPE_T_ORDERS REFRESH;
