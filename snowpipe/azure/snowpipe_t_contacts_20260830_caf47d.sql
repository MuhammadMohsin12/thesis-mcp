...
================================================================================
  ...
  Database:   TEST_DB
  Schema:     TEST_SCHEMA
  Generated:  2026-08-30T22:25:54Z
...
--     4. Table               : TEST_DB.TEST_SCHEMA.T_CONTACTS
--     5. Pipe                : TEST_DB.TEST_SCHEMA.PIPE_T_CONTACTS
================================================================================
*/
...
CREATE OR REPLACE TABLE TEST_DB.TEST_SCHEMA.T_CONTACTS (
...
-- ============================================================================
-- 6. PIPE: PIPE_T_CONTACTS
-- ============================================================================

CREATE OR REPLACE PIPE TEST_DB.TEST_SCHEMA.PIPE_T_CONTACTS
    AUTO_INGEST = TRUE
    INTEGRATION = 'NOTIF_INT_THESIS'
AS
COPY INTO TEST_DB.TEST_SCHEMA.T_CONTACTS
FROM (
    SELECT
...
================================================================================
  ...
  4. Test each pipe:
       ALTER PIPE TEST_DB.TEST_SCHEMA.PIPE_T_CONTACTS REFRESH;
